...
class Block {
  static get(id, options = {}) {
    return FantasyGoldinfoAPI.get(`/block/${id}`, options)
  }

  static getRecentBlocks(options = {}) {
    return FantasyGoldinfoAPI.get('/recent-blocks', options)
  }

  static getBlocksByDate(date = new Date(), options = {}) {
    return FantasyGoldinfoAPI.get('/blocks', {params: {date: formatTimestamp(date)}, ...options})
  }
}
