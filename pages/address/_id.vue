<template>
  <section class="container">
      ...
      <div class="card-body info-table">
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">
            {{ balance | fantasygold }} FGC
            <span v-if="unconfirmed !== '0' && staking !== '0'">
              ({{ unconfirmed | fantasygold }} FGC {{ $t('address.unconfirmed') }},
              {{ staking | fantasygold }} FGC {{ $t('address.staking') }})
            </span>
    ...
    <nuxt-child :tokens="fgc20Balances.map(({address, addressHex, name, symbol}) => ({address, addressHex, name, symbol}))" />
  </section>
</template>
