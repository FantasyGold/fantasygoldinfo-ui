    ...
    <div class="card section-card">
      ...
      <div class="card-body info-table">
        ...
        <div class="columns" v-if="fees > 0">
          ...
          <div class="column info-value monospace">{{ fees | fantasygold }} FGC</div>
        </div>
        ...
        <Transaction
          :transaction="{
            ...
            contractSpends,
            fgc20TokenTransfers, fgc721TokenTransfers
          }"
          detailed
  ...
  export default {
    ...
    async asyncData({req, params, error}) {
      try {
        ...
        return {
          ...
          fgc20TokenTransfers: transaction.fgc20TokenTransfers,
          fgc721TokenTransfers: transaction.fgc721TokenTransfers
        }
      } catch (err) {
    ...
    methods: {
      refresh(transaction) {
        ...
        this.fgc20TokenTransfers = transaction.fgc20TokenTransfers
        this.fgc721TokenTransfers = transaction.fgc721TokenTransfers
      },
      splitData(data) {
