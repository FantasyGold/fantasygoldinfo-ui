<template>
  <div class="columns is-multiline transaction-item">
    ...
    <template v-for="({addressHex, name, symbol, decimals, from, fromHex, to, toHex, value}, index) in fgc20TokenTransfers">
      <div class="column is-full flex-full"></div>
      <AttributeInjector
    ...
    <template v-for="({addressHex, name, symbol, from, fromHex, to, toHex, tokenId}, index) in fgc721TokenTransfers">
      <div class="column is-full flex-full"></div>
      <AttributeInjector
        class="column collapse token-transfer-list"
        :class="{
